import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as l,o as c,c as o,a as n,d as s,b as e,e as t}from"./app-3dGJw9wW.js";const p={},r=t(`<h1 id="编写敏感词库" tabindex="-1"><a class="header-anchor" href="#编写敏感词库"><span>编写敏感词库</span></a></h1><div class="hint-container info"><p class="hint-container-title">本节内容</p><p>本节将介绍敏感词库的编写，请善用侧边栏和搜索，按需阅读文档。</p></div><h2 id="创建文本格式的敏感词库" tabindex="-1"><a class="header-anchor" href="#创建文本格式的敏感词库"><span>创建文本格式的敏感词库</span></a></h2><p>你可以直接按照以下格式书写 <code>&lt;words&gt;.txt</code>：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>#notice
提醒级词汇 1
提醒级词汇 2
